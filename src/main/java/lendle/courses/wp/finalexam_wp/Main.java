...
public class Main extends javax.swing.JFrame {
    ...
    private void buttonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonNewActionPerformed
        ...
        //加到 jDesktopPane1 (20%)
            JInternalFrame TaskFame =new JInternalFrame();
            TaskFame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
            TaskFame.setSize(500, 500);
            TaskFame.setLayout(new BorderLayout());
            JDesktopPane jDesktopPane = new JDesktopPane();
            TaskFame.setContentPane(jDesktopPane);
            TaskFame.setVisible(true);
        ///////////////////////////////////////
